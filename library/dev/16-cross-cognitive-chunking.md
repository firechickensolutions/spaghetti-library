...
**The AI generation failure mode:** agents generate "single-pass clever" functions with many live flags, accumulated intermediate state, and nested conditionals, then compensate with comments. The comments describe what the code does instead of decomposing the cognitive load.
