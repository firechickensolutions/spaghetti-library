...
```
library/dev/          16 sourced coding patterns (SQL, Python, TypeScript/React, PowerShell, cross-language)
  README.md           Trigger routing table — maps agent-recognizable conditions to entries
  01-*.md ... 16-*.md One file per pattern

skills/dev/
  SKILL.md            The /dev skill — how an AI agent uses this library at generation time

architecture/
  README.md           System architecture overview — hub, spokes, library, skill routing
```
